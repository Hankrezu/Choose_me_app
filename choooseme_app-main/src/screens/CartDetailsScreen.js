...
const CartDetailsScreen = ({ navigation, route: { params: { restaurantId } } }) => {
          ...
          <ScrollView>
            ...
            <View style={styles.amountContainer}>
              <View style={styles.amountSubContainer}>
                ...
                <Text style={styles.amountText}>
                   {cartItemsByRestaurant?.metaData?.itemsTotal} đ
                </Text>
              </View>
              <View style={styles.amountSubContainer}>
                <Text style={styles.amountLabelText}>Discount</Text>
                <Text style={styles.amountText}>
                   {cartItemsByRestaurant?.metaData?.discount} đ
                </Text>
              </View>
              <View style={styles.amountSubContainer}>
            ...
            <View style={styles.totalContainer}>
              ...
              <Text style={styles.totalText}>
                 {cartItemsByRestaurant?.metaData?.grandTotal} đ
              </Text>
            </View>
